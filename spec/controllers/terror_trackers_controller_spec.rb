...
RSpec.describe TerrorTrackersController, :type => :controller do

  # This should return the minimal set of attributes required to create a valid
  # TerrorTracker. As you add validations to TerrorTracker, be sure to
  ...
  # TerrorTrackersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
